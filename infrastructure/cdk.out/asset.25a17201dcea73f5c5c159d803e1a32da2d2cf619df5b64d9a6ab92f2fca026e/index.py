...
def handler(event, context):
    try:
        ...
        # Información del cliente (desde JWT y datos adicionales)
        customer_info = {
            'name': user_email.split('@')[0],  # Usar parte del email como nombre por defecto
            'email': user_email,
            'phone': '',  # Por ahora vacío, se puede agregar después
            'userId': user_id,
